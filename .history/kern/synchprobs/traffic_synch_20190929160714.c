...
static struct array * intersection_block_N;
static struct array * intersection_block_S;
static struct array * intersection_block_E;
static struct array * intersection_block_W;
